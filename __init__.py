...
#UI -------------------------------------------------------------------------------------
class VIEW3D_PT_lr_export_setup(bpy.types.Panel):
    bl_label = "LR EXPORT"
    bl_idname = "OBJECT_PT_lr_export_setup"
...
class VIEW3D_PT_lr_export(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        # layout.label(text="Settings")
        row = layout.row(align=True)
        row.prop(lr_export, "export_sm_prefix")
...
classes = [lr_export_settings,OBJECT_OT_lr_hierarchy_exporter,VIEW3D_PT_lr_export_setup,VIEW3D_PT_lr_export, VIEW3D_PT_lr_export_assembly, OBJECT_OT_store_object_data_json]
